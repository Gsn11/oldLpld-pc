...
export class IndexComponent implements OnInit {
    ...
    constructor(
        ...
        this.crumbsList = [
            ...
            { name: '厂商管理', open: false }
        ];
        this.setConfim = false;
        this.displayedColumns = ['FName', 'FLocalName', 'Province', 'City', 'Id', 'Other'];
    ...
    gotoAdd() {
        ...
        this.router.navigate(['index/facturer/add']);
    }
    ...
    gotoInfo(el: object) {
        ...
        localStorage.setItem('BemPageIndex', JSON.stringify(this.pageIndex));
        localStorage.setItem('BemPageSize', JSON.stringify(this.pageSize));
        this.router.navigate(['index/facturer/info']);
    }
    ...
    tableConfimResult(...data: boolean[]) {
        ...
        if (confimResultState === true) {
            this.service.serviceR('ent/params/facturer/10604', { FSeqs: this.chooseDeleteSeq }, (res: any) => {
                if (res.ResultCode === 0) {
